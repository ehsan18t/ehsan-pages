...
const Introduction = () => {
  return (
    <div className="h-full flex flex-col gap-2 justify-center">
      ...
      <div className="text-4xl sm:text-6xl font-bold text-cyan-600">
        <MotionH1
      ...
      <div className="w-full p-1 sm:text-xl text-justify pt-5">
        ...
        >
          ...
          TailWindCSS, JavaScript, TypeScript, MySQL and Git. Additionally, I have
          experience with C++, C, Java, PostgreSQL, MongoDB, Docker, Linux, and many more.
          Currently, I am actively working on a NLP based project with Django, NextJS,
