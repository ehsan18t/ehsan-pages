...
const info = {
    ...
    experiences: [
        ...
        },
        {
            ...
            techStack: ['Next.js', 'Payload CMS', 'Cloudflare', 'Cloudinary', 'TypeScript', 'TailwindCSS'],
            lane: 'fullstack',
            impact: [
...
export const { name, title, description, socials, resume, experiences, testimonials, projects, navItems } = info;
